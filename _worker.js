...
// 建议修改为自己的 UUID
let userID = '7b80bda0-97af-4796-a0eb-b4400285fb50';

// 生成配置文件的 CF 优选 IP
const bestCFIP = "www.gov.se"

// 用于 CF 网站的代理 IP
const proxyIPs = ["8.219.87.34"]; // const proxyIPs = ['cdn-all.xn--b6gac.eu.org', 'cdn.xn--b6gac.eu.org', 'cdn-b100.xn--b6gac.eu.org', 'edgetunnel.anycast.eu.org', 'cdn.anycast.eu.org'];
